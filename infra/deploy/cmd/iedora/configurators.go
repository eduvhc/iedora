...
var appConfigurators = []appConfigurator{
	{
		...
		// targets, admin grants — see infra/app-state/cmd/zitadel-apply/.
	...
	},
	{
		...
		// at MENU_IMAGE_SHA. See infra/app-state/cmd/menu-db-migrations/.
	...
	},
	{
		...
		// time. See `infra/app-state/cmd/openobserve-dashboards/`.
