...
**Env:** Non-secret CI fixture literals (`DATABASE_URL`, `CORE_DATABASE_URL`, `S3_*`, `CORE_SECRET=test...`) live at job-level. No CI-side secrets — production auth values are TF-minted at apply time and written to BWS.
